...
// here as well we have to consider some modification, generally it does not seem so difficult
  ...
  for (int i = 0; i < nlist; i++) {
    ...
    else if (which[i] == QCM) ivalue = 16*sites[O]+17*sites[OH]+178.5*sites[Hf]+18*sites[OH2]+240.5*sites[OH2HfX]+241.5*sites[OH2HfHX]+240.5*sites[OHHfHX]+196.5*sites[OH2Hf]+222.5*sites[HfX]+223.5*sites[HfHX]+266.5*sites[HfX2]+267.5*sites[HfHX2]+268.5*sites[HfH2X2]+282.5*sites[HfX2O]+283.5*sites[HfHX2O]+284.5*sites[HfH2X2O]+283.5*sites[HfX2OH]+284.5*sites[HfHX2OH]+285.5*sites[HfH2X2OH]+326.5*sites[HfX3O]+327.5*sites[HfHX3O]+328.5*sites[HfH2X3O]+329.5*sites[HfH3X3O]+327.5*sites[HfX3OH]+328.5*sites[HfHX3OH]+329.5*sites[HfH2X3OH]+330.5*sites[HfH3X3OH]+370.5*sites[HfX4O]+371.5*sites[HfHX4O]+372.5*sites[HfH2X4O]+373.5*sites[HfH3X4O]+374.5*sites[HfH4X4O]+371.5*sites[HfX4OH]+372.5*sites[HfHX4OH]+373.5*sites[HfH2X4OH]+374.5*sites[HfH3X4OH]+375.5*sites[HfH4X4OH];
